...
# serialization should live in segy_tools where available.
#
# Repository layout is intentionally explicit and singular:
#
#     repo/
#       apps/wiggle_picker.py
#       lib/segy_tools/
#
# Run from the repository root with:
#
#     python apps/wiggle_picker.py
#
# We add only repo/lib to sys.path.  If segy_tools.db is not importable from
# there, database geometry fails loudly instead of silently searching elsewhere.
