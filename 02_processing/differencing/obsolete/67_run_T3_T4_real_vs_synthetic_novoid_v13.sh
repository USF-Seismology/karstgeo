...
#
# Default run:
#   bash 67_run_T3_T4_real_vs_synthetic_novoid_v13.sh
#
# Common controls:
...
#   coordinates before matching synthetic source/receiver positions. Override with:
#
...
OUT_ROOT="${OUT_ROOT:-$BASE/02_Modelling/Seismic/differencing/real_vs_synthetic_novoid_T3_T4_v13}"
MOVIE_ROOT="${MOVIE_ROOT:-$BASE/02_Modelling/Seismic/differencing/movies_real_vs_synthetic_novoid_T3_T4_v13}"
