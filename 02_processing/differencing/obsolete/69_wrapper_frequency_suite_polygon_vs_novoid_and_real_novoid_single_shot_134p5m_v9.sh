#!/usr/bin/env bash
# 69_wrapper_frequency_suite_polygon_vs_novoid_and_real_novoid_single_shot_134p5m_v9.sh
#
...
OUT_ROOT="${OUT_ROOT:-$BASE/02_Modelling/Seismic/differencing/frequency_suite_polygon_vs_novoid_and_real_novoid_single_shot_134p5m_v9}"
MOVIE_ROOT="${MOVIE_ROOT:-$BASE/02_Modelling/Seismic/differencing/movies_frequency_suite_polygon_vs_novoid_and_real_novoid_single_shot_134p5m_v9}"
