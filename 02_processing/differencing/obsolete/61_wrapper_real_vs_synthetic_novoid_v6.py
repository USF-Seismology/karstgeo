...
# The no-void run may not contain DATA/STATIONS. Use the known-good DATA folder
# from the corresponding void model; STATIONS and SOURCES_LIST.txt should be
# identical for these paired model runs.
VOID_MODEL = SOURCES_GROUNDED / "9_LAYER_MODEL_TOPO_VOID_T1_1m_50Hz_DX_DZ_0d5m_DT_1e-5s"
DATA_DIR = VOID_MODEL / "DATA"
...
SCRIPT = Path(__file__).with_name("61_compare_real_geode_vs_synthetic_novoid_v6.py")
