#!/usr/bin/env bash
# 69_wrapper_frequency_suite_polygon_vs_novoid_and_real_novoid_single_shot_134p5m_v10.sh
#
...
ENGINE="${ENGINE:-$SCRIPT_DIR/65_compare_gather_pairs_v14.py}"
...
OUT_ROOT="${OUT_ROOT:-$BASE/02_Modelling/Seismic/differencing/frequency_suite_polygon_vs_novoid_and_real_novoid_single_shot_134p5m_v10}"
MOVIE_ROOT="${MOVIE_ROOT:-$BASE/02_Modelling/Seismic/differencing/movies_frequency_suite_polygon_vs_novoid_and_real_novoid_single_shot_134p5m_v10}"
