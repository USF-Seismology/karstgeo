...
OUT_ROOT="${OUT_ROOT:-$BASE/02_Modelling/Seismic/differencing/comparison_products_v17}"
MOVIE_ROOT="${MOVIE_ROOT:-$BASE/02_Modelling/Seismic/differencing/movies_v17}"
...
echo "Engine:       $ENGINE"
echo "SEG-Y:       processed gathers enabled; f-k gathers enabled when WRITE_FK=1"
