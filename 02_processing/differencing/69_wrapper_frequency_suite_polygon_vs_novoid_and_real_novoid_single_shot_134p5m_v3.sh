#!/usr/bin/env bash
# 69_wrapper_frequency_suite_polygon_vs_novoid_and_real_novoid_single_shot_134p5m_v3.sh
#
...
OUT_ROOT="${OUT_ROOT:-$BASE/02_Modelling/Seismic/differencing/frequency_suite_polygon_vs_novoid_and_real_novoid_single_shot_134p5m_v3}"
MOVIE_ROOT="${MOVIE_ROOT:-$BASE/02_Modelling/Seismic/differencing/movies_frequency_suite_polygon_vs_novoid_and_real_novoid_single_shot_134p5m_v3}"
...
# Real T1 1-m refraction defaults. Supply REAL_DIR to enable real comparisons.
REAL_DIR="${REAL_DIR:-}"
...
run_real_novoid_frequency_component() {
  ...
  syn_rel="$(resolve_component_relpath "$novoid_root" "$component_file")"
