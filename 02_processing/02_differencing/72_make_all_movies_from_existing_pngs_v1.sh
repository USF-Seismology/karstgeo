...
DIFF_ROOT="${DIFF_ROOT:-$BASE/02_Modelling/Seismic/differencing}"
...
T1_ROOT="$DIFF_ROOT/comparison_products_v18_consolidated"
T1_MOVIES="$DIFF_ROOT/movies_v18_consolidated"
