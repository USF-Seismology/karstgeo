...
OUT_ROOT="${OUT_ROOT:-$BASE/02_Modelling/Seismic/differencing/real_vs_synthetic_novoid_T3_T4_v16}"
MOVIE_ROOT="${MOVIE_ROOT:-$BASE/02_Modelling/Seismic/differencing/movies_real_vs_synthetic_novoid_T3_T4_v16}"
