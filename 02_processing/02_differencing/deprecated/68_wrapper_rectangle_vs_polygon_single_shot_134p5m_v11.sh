...
#
# Run:
#   bash 68_wrapper_rectangle_vs_polygon_single_shot_134p5m_v11.sh
...
OUT_ROOT="${OUT_ROOT:-$BASE/02_Modelling/Seismic/differencing/rectangle_vs_polygon_single_shot_134p5m_v17}"
MOVIE_ROOT="${MOVIE_ROOT:-$BASE/02_Modelling/Seismic/differencing/movies_rectangle_vs_polygon_single_shot_134p5m_v17}"
...
COMMON_ARGS=(
  ...
  --write-diff-segy
  --write-gather-segys
  --gather-segy-processed-dirname "processed"
...
echo "WRITE_FK:       $WRITE_FK"
echo "WRITE_BANDPASS: $WRITE_BANDPASS"
echo
