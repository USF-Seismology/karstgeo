#!/usr/bin/env python3
"""
101_plot_virtual_T1_shot_gathers_v3.py
...
Version 3 retains the fixed axes and onset-relative display for the hierarchically integrated gathers: receiver x is fixed by command-line limits,
