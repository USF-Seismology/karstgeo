#!/usr/bin/env bash
# 102_make_virtual_T1_animation_v3.sh
#
...
PLOTTER="${PLOTTER:-$SCRIPT_DIR/101_plot_virtual_T1_shot_gathers_v3.py}"
MOVIE_SCRIPT="${MOVIE_SCRIPT:-$SCRIPT_DIR/../02_differencing/66_make_movies_from_shot_figures_v5.sh}"
